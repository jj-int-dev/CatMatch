        ...
        <div className="h-full w-full bg-[#f9f9f9] px-6 py-8">
          <div className="grid grid-cols-12 gap-y-10">
            <div className="col-span-12 flex flex-row gap-x-4 sm:col-span-6">
              <div className="skeleton bg-skeleton bg-skeleton-base h-[3rem] w-[3rem] rounded-full" />
              <div className="pt-3">
                <div className="skeleton bg-skeleton bg-skeleton-base h-[1.499rem] w-[5.701rem]" />
              </div>
            </div>
          ...
          <fieldset className="fieldset rounded-box mt-6 w-md border border-[#b8d2f1] bg-white p-4">
            ...
            <div className="skeleton bg-skeleton bg-skeleton-base h-[2.5rem] w-[25.887rem]" />
            ...
            <div className="skeleton bg-skeleton bg-skeleton-base h-[1.125rem] w-[4.375rem]" />
            <div className="skeleton bg-skeleton bg-skeleton-base h-[5rem] w-[25.887rem]" />
          </fieldset>
          <div className="mt-6 flex flex-col max-sm:items-center max-sm:gap-y-3 max-sm:pb-6 sm:flex-row sm:justify-between">
            <div className="skeleton bg-skeleton bg-skeleton-base h-[1.499rem] w-[7.774rem]" />
            <div className="skeleton bg-skeleton bg-skeleton-base h-[1.499rem] w-[7.774rem]" />
            <div className="skeleton bg-skeleton bg-skeleton-base h-[1.499rem] w-[7.774rem]" />
          </div>
        </div>
