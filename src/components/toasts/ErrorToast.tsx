...
export default function ErrorToast({ messages, onCloseToast }: ToastProps) {
  return (
    <div className="toast toast-top toast-center z-50 w-full max-w-xs px-4 sm:max-w-sm md:max-w-md lg:max-w-lg">
      <div className="alert alert-error border-error/20 rounded-xl border-2 shadow-2xl backdrop-blur-sm">
          ...
          {onCloseToast && (
            <div className="flex flex-shrink-0 items-center justify-center">
              <button
                ...
                className="btn btn-circle btn-ghost btn-sm hover:bg-error/20 transition-colors duration-200"
                aria-label="Close"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
